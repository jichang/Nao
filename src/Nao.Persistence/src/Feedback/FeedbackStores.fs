...
module AdoTurnStore =
    let create (factory: DbConnectionFactory) : TurnStore =
        ...
        { SaveAsync = fun turn -> AdoPayload.upsert factory table turn.TurnId turn
          GetAsync = fun turnId ->
            task {
...
module AdoFeedbackStore =
    let create (factory: DbConnectionFactory) : FeedbackStore =
        ...
        { SaveAsync = fun feedback -> AdoPayload.upsert factory table (feedback.Id.ToString("D")) feedback
          ...
          GetAllAsync = fun () -> AdoPayload.getAll<Feedback> factory table }
    ...
    let create (baseDir: string) : FeedbackStore =
        ...
        { SaveAsync = fun feedback ->
          ...
          GetForSessionAsync = fun sessionId ->
            ...
            |> Task.FromResult
          GetAllAsync = fun () -> Jsonl.readAll<Feedback> path |> Task.FromResult }
...
module FeedbackDb =
    ...
    let file (baseDir: string) : FeedbackService =
        ...
        FeedbackService.create
            (FileTurnStore.create baseDir)
            (FileFeedbackStore.create baseDir)
    ...
    let database (factory: DbConnectionFactory) : FeedbackService =
        FeedbackService.create
            (AdoTurnStore.create factory)
            (AdoFeedbackStore.create factory)
