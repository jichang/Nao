...
/// Tool discovery and pruning for context-window efficiency.
/// Implementations receive compiled tools or MCP-discovered schemas through registration;
/// this type does not load assemblies.
